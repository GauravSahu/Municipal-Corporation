...
import static Final.smsserver.flag;
...
public class smsserver extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		{
                    if(flag == 1){
                        out.println("Enter the following Options:<br>'Help BCS' for birth <br>'Help DCS' for death query<br>");
                        }
                    else if(flag==2){
			...
			if(test[1].equals("LFS")){
                       ...
                       try{
                           ...
                           PreparedStatement pstmt=null;
                            ...
                            String jdbc_url="jdbc:mysql://localhost:3306/municipal";
                            String user="root";
                            String password="";

                            String tb_name=test[0];
                            smsserver.Tables tb = smsserver.Tables.valueOf(tb_name);
                            ...
                            switch(tb){
                                 case BCS:
                                    pstmt =con.prepareStatement("Select * From child_birth Where child_id = ? ");
                                    pstmt.setString(1,test[1]);
                                    rst = pstmt.executeQuery();
                                    if(rst.next()){
                                        
                                         String Ulb = "";
                                            pstmt1 =con.prepareStatement("Select * From ulb_master Where ulb_id = ? ");
                                            pstmt1.setInt(1,rst.getInt(9));
                                            rst1 = pstmt1.executeQuery();
                                              if(rst1.next()){
                                                   Ulb = rst1.getString("ulb_name");
                                              }
                                         String Name = rst.getString(2);
                                         String Dob = rst.getString(6);
                                         String Status = rst.getString(21);
                                         if(Status.equals("0")){
                                             Status = "At Verifier";
                                         }
                                         else{
                                        ...
                                        // String Auth = rst.getString(2);
                                         out.println("ULB:"+Ulb+" Nagar Nigam<br>Name:"+Name+"<br>Dob:"+Dob+"<br>Status:"+Status+"<br>Health Commissioner<br>");
                                     }
                                     else{
                                        out.println("Invalid");
                                     }
                                 break;
                                case DCS:
                                     pstmt =con.prepareStatement("Select * From person_death Where person_id = ? ");
                                     pstmt.setString(1,test[1]);
                                     rst = pstmt.executeQuery();
                                      if(rst.next()){
                                           String Ulb = "";
                                         ...
                                         String Name = rst.getString(2);
                                         String DoD = rst.getString(7);
                                         String Status = rst.getString(22);
                                         if(Status.equals("0")){
                                             Status = "At Verifier";
                                         }
                                         else{
                                         ...
                                         out.println("ULB:"+Ulb+" Nagar Nigam<br>Name:"+Name+"<br>DoD:"+DoD+"<br>Status:"+Status+"<br>Health Commissioner<br>");
                                     }
                                     else{
                                        out.println("Invalid");
                                     }
