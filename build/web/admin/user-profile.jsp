                        ...
                        <div class="portlet portlet-default">
                            <div class="portlet-body">
                                <ul id="userTab" class="nav nav-tabs">
                                    <li class="active"><a href="profile.html#overview" data-toggle="tab">Overview</a>
                                    </li>
                                    <li class=""><a href="profile.html#profile-settings" data-toggle="tab">Update Profile</a>
                                    </li>
                                </ul>
                                    ...
                                    <div class="tab-pane fade active in" id="overview">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-2 col-md-3">
                                                ...
                                                <img class="img-responsive img-profile"  src="http://localhost:8084/Final/admin/BDR/<%out.print(id);%>.jpg" alt="">
                                                <div class="list-group">
                                                    <a href="profile.html#" class="list-group-item active">Overview</a>
                                                    <a href="profile.html#" class="list-group-item">Messages<span class="badge green">4</span></a>
                                                    <a href="profile.html#" class="list-group-item">Alerts<span class="badge orange">9</span></a>
                                                    <a href="profile.html#" class="list-group-item">Tasks<span class="badge blue">10</span></a>
                                                </div>
                                            </div>
                                            <div class="col-lg-7 col-md-5">
                                                <h1><%out.print(name);%></h1>
                                                <p>Hi, Gaurav here! I am an engineering student, graduating from the Pranveer Singh Institute of Technology,College of Engineering Kanpur.
My extensive work in IT has offered me a well grounded experience in software testing, Java applications, and troubleshooting of software programs.
I am not only capable of developing new software programs for use; but also, experienced in improving software applications.
I know that my experience and talents with software, as well as my outstanding interpersonal skills make me a more viable candidate than anyone else you may have in mind
I thank you for your time.</p>
                                            ...
                                            <div class="col-lg-3 col-md-4">
                                                ...
                                                <p><i class="fa fa-globe fa-muted fa-fw"></i>  <a href="profile.html#">http://www.gnuts.in</a>
                                                </p>
                                                <p><i class="fa fa-phone fa-muted fa-fw"></i> +918090779037</p>
                                                <p><i class="fa fa-building-o fa-muted fa-fw"></i> PSIT BOYS HOSTAL
                                                    <br>KANPUR 208020</p>
                                                <p><i class="fa fa-envelope-o fa-muted fa-fw"></i>  <a href="profile.html#">gauravsahu19@gnuts.in</a>
                                                </p>
                                                <ul class="list-inline">
                                                    <li><a class="facebook-link" href="profile.html#"><i class="fa fa-facebook-square fa-2x"></i></a>
                                                    </li>
                                                    <li><a class="twitter-link" href="profile.html#"><i class="fa fa-twitter-square fa-2x"></i></a>
                                                    </li>
                                                    <li><a class="linkedin-link" href="profile.html#"><i class="fa fa-linkedin-square fa-2x"></i></a>
                                                    </li>
                                                    <li><a class="google-plus-link" href="profile.html#"><i class="fa fa-google-plus-square fa-2x"></i></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <ul id="userSettings" class="nav nav-pills nav-stacked">
                                                    <li class=""><a href="profile.html#basicInformation" data-toggle="tab"><i class="fa fa-user fa-fw"></i> Basic Information</a>
                                                    </li>
                                                    <li class=""><a href="profile.html#profilePicture" data-toggle="tab"><i class="fa fa-picture-o fa-fw"></i> Profile Picture</a>
                                                    </li>
                                                    <li class="active"><a href="profile.html#changePassword" data-toggle="tab"><i class="fa fa-lock fa-fw"></i> Change Password</a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="col-sm-9">
                                                <div id="userSettingsContent" class="tab-content">
                                                    ...
                                                    <div class="tab-pane fade" id="profilePicture">
                                                        ...
                                                        <img class="img-responsive img-profile" src="http://localhost:8084/Final/admin/BDR/1034810001.jpg" hieght='500px' width="350px" alt="">
                                                        <br>
                                                        <form role="form">
                                                            <div class="form-group">
