                            ...
                            <div class="portlet-body">
                                        ...
                                        <ul class="nav navbar-nav button-tooltips">
                                            ...
                                            <li class="message-actions">
                                                <div class="btn-group navbar-btn">
                                                    <button type="button" class="btn btn-white" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Archive"><i class="fa fa-archive"></i>
                                                    </button>
                                                    <button type="button" class="btn btn-white" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Mark as Important"><i class="fa fa-exclamation-circle"></i>
                                                    </button>
                                            ...
                                            <li class="dropdown message-label">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a href="mailbox.html#"><i class="fa fa-square text-green"></i> Purchase Orders</a>
                                                    </li>
                                                    <li><a href="mailbox.html#"><i class="fa fa-square text-orange"></i> Current Projects</a>
                                                    </li>
                                                    <li><a href="mailbox.html#"><i class="fa fa-square text-purple"></i> Work Groups</a>
                                                    </li>
                                                    <li><a href="mailbox.html#"><i class="fa fa-square text-blue"></i> Personal</a>
                                                    </li>
                                                    <li><a href="mailbox.html#"><i class="fa fa-square-o"></i> None</a>
                                                    </li>
                                                </ul>
                                            </li>
                                        </ul>
                                ...
                                <div id="mailbox">
                                    ...
                                    <ul class="nav nav-pills nav-stacked mailbox-sidenav">
                                        <li><a class="btn btn-white" onclick="composemail()"><i class="fa fa-edit"></i> Compose Message</a>
                                        </li>
                                        <li class="nav-divider"></li>
                                        <li class="mailbox-menu-title text-muted">Folder</li>
                                        <li class="active"><a href="mailbox.html#">Inbox (15)</a>
                                        </li>
                                        <li><a href="mailbox.html#">Sent</a>
                                        </li>
                                        <li><a href="mailbox.html#">Drafts</a>
                                        </li>
                                        <li><a href="mailbox.html#">Spam</a>
                                        </li>
                                        <li><a href="mailbox.html#">Trash</a>
                                        </li>
                                        <li class="nav-divider"></li>
                                        ...
                                        <li><a href="mailbox.html#"><i class="fa fa-plus"></i> Create New Label</a>
                                        </li>
                                    </ul>
