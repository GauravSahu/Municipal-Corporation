	...
	<div id="page" class="hfeed site">
		...
		<div class="container site-content">
                                                            ...
                                                            <div class="wow-pricing-table span12">
                                                                <div class="wow-pricing featured wow-column-">
                                                                    <div class="wow-pricing-header">
                                                                         <h4 >Verify Death Certificate</h4>
			...
			<table class="table-hover">
                                    <tr>
				<td>Death Registration No : </td>
                                <td><input type="text" id="child_id" name="person_id" required ></td>
			</tr>
                           ...
                           <tr>
                             <td align='right'> <br><input type="button"  id="add_death"  value="Submit" class="sbutton square small blue"></td>
