<%-- 
    ...
    Created on : 3 Oct, 2013, 11:31:25 PM
    Author     : QWERTY
--%>
...
xmlhttp.open("GET","captchasubmit.jsp?q="+0,true);
xmlhttp.send();
}
</script>
                                                    ...
                                                    <div class="row-fluid">
                                                            <div class="wow-pricing-table span12">
                                                                <div class="wow-pricing featured wow-column-">
                                                                    ...
                                                                    <center>
                                                                    <div class="boxgray coloredbox pull-none" style="width:700px; ">
                                                                          <div class="padding15"> 
                                                                              <form name="myForm" class='form-inline' action="../BirthCertificate" method="post">
				...
				<td>Child Registration No : </td>
                           ...
                           <tr>
                            ...
                            <tr>
                                ...
                                <td id="mydiv" colspan="2"></td>
                           </tr>
                             
                           <tr>
                             <td align='right'> <br><input type="submit" onclick="return valid()" value="Submit" class="sbutton square small blue"></td>
