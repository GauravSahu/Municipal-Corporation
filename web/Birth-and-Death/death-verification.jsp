<%-- 
    Document   : death-verification
    Created on : 5 Oct, 2013, 3:45:39 PM
    Author     : gaurav
--%>
		...
		<div class="container site-content">
			<div class="row-fluid">
				...
				<td>Registration No : </td>
                                <td><input type="text" name="child_id"></td>
			</tr>
			<tr>
				<td>Gender : </td>
			...
			<tr>
			 ...
			 <tr>
                           ...
                           <tr>
                             <td align='right'> <br><input type="submit" value="Submit" class="sbutton square small blue"></td>
